...
/**
 * @brief in算子
 * @details 依次遍历左表的每一行,右表的每一行作比较
 * @ingroup PhysicalOperator
 */
class InJoinPhysicalOperator : public PhysicalOperator
{
public:
  InJoinPhysicalOperator();
  virtual ~InJoinPhysicalOperator() = default;

  PhysicalOperatorType type() const override { return PhysicalOperatorType::IN; }
